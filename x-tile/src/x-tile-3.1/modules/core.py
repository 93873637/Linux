...
class XTile:
    ...
    def init_from_gconf(self):
        ...
        if self.gconf_client.get_int(cons.GCONF_OVERRIDE_1 % glob.screen_index) == 1:
            ...
            print("###@:init_from_gconf: monitors_areas[0]: cons X1=" + str(cons.X1) + ", Y1=" + str(cons.Y1) + ", W1=" + str(cons.W1) + ", H1=" + str(cons.H1));
    ...
    def on_configwin_close_button_clicked(self, *args):
        ...
        if cons.OVERRIDE_1 == 1:
            print("on_configwin_close_button_clicked: monitors_areas[0]: cons X1=" + str(cons.X1) + ", Y1=" + str(cons.Y1) + ", W1=" + str(cons.W1) + ", H1=" + str(cons.H1));
            glob.monitors_areas[0] = [cons.X1, cons.Y1, cons.W1, cons.H1]
