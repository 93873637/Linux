...
#define UART_TRANSPORT 0
#define CAN_TRANSPORT  1
...
struct port_interface {
	...
	port_err_t (*read)(struct port_interface *port, void *buf, size_t nbyte, size_t *nread);
...
port_err_t port_open(struct port_options *ops, struct port_interface **outport, int transport);
